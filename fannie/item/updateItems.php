...
echo "<table border=0>";
echo "<tr><td align=right><b>UPC</b></td><td colspan='3'><font color='red'>".$row['upc']."</font><input type=hidden value='$row[0]' name=upc></td>";
echo "</tr><tr><td><b>Description</b></td><td>".$row['description']."</td>";
echo "<td><b>Price</b></td><td>$".$row['normal_price']."</td></tr></table>";
echo "<table border=0><tr>";
echo "<th>SubDept<th>Category<th>FS<th>Scale<th>QtyFrc<th>NoDisc<th>inUse<th>deposit</b>";
echo "</tr>";
echo "<tr>";
$dept=$row['department'];
