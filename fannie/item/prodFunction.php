...
function itemMaintenance($new,$input) {
	...
	echo "<th>SubDept & Category</th><th>FS</th><th>Scale</th><th>QtyFrc</th><th>NoDisc</th><th>Tax</th><th>Active</th>";
	echo "</tr>\n";
	echo "<tr valign=top>";
	echo "<td align=left>";	
	
	$dresult = mysql_query("SELECT * FROM departments ORDER BY dept_no");
	...
	$sresult = mysql_query("SELECT * FROM subdepts ORDER BY dept_ID, subdept_name");
	...
	echo "></td>\n<td align=center><input type=checkbox value=1 name=tax";
		if($new != 1 && $rowItem['tax'] == 1){
		echo " checked";
		} elseif ($new == 1) {
			echo " checked";
		}
	...
	$dictR = mysql_query("SELECT * FROM item_properties WHERE name <> ''");
